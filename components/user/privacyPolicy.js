            ...
            <Card className={classes.aboutContent} elevation={1}>
                ...
                <CardContent>
                    <Typography className={classes.content} variant="body2" color="textSecondary" component="p">
                        ...
                        or non-characteristic words etc. There are many variations of passages of Lorem
                        ...
                        words etc. generate Lorem Ipsum which looks reasonable. The generated Lorem
                        Ipsum is therefore always free from repetition, injected humour, or noncharacteristic
                        words etc.
                    </Typography>
                </CardContent>
            </Card>
